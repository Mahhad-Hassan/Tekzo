...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className='border relative border-gray-100 rounded-2xl cursor-pointer hover:scale-105 hover:shadow-2xl transition-all p-2 h-max'>
      ...
      <button  onClick={()=>addToCart(product)} className='bg-red-500 px-3 py-2 text-md rounded-md text-white w-full cursor-pointer flex gap-2 items-center justify-center font-semibold'>
