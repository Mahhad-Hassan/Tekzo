...
const MidBanner = () => {
  return (
    <div className='bg-gray-100 md:py-24'>
        <div className='relative max-w-7xl mx-auto md:rounded-2xl pt-28 bg-cover bg-center h-[550px] md:h-[600px]  ' style={{background:`url(${banner})`,backgroundPosition:"center", backgroundAttachment:'fixed', backgroundSize:'80%' }}>
            <div className='absolute inset-0 bg-black/60 md:rounded-2xl bg-opacity-50 flex items-center justify-center'>
                <div className='text-center text-white px-4'>
                  ...
                  <p className='text-lg md:text-xl mb-6'>Discpver the latest tech innovations with unstable prices and free shipping on all orders</p>
