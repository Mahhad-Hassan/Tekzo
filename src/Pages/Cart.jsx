          ...
          <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 md:gap-20 '>
              <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
                ...
                <div className='flex  flex-col space-y-01'>
                  <label htmlFor="">Address</label>
                  <input type="text" placeholder='Enter your Address' className='p-2 rounded-md'value={location?.state} />

                </div>
                <div className='flex w-full gap-5'>
                 <div className='flex  flex-col space-y-01 w-full'>
                   <label htmlFor="">State</label>
                  <input type="text" placeholder='Enter your State' className='p-2 rounded-md w-full'value={location?.postcode} />
                  </div>
                    <div className='flex  flex-col space-y-01 w-full'>
                   <label htmlFor="">PostCode</label>
                  <input type="text" placeholder='Enter your PostCode' className='p-2 rounded-md w-full'value={location?.country} />
                  </div>
                </div>
                <div className='flex w-full gap-5'>
                 <div className='flex  flex-col space-y-01 w-full'>
                ...
                <button className='bg-red-500 text-white px-3 py-1 rounded-md mt-3 cursor-pointer '>Submit</button>
                                <div className='flex items-center justify-center w-fulltext-gray-700'>
                  ---------OR---------
                </div>
                ...
                <div>
                  ...
                  <div className='flex gap-3'>
                    ...
                    <button className='bg-white text-black border border-gray-200 px-4 cursor-pointer'>Apply</button>
                  </div>
                </div>
